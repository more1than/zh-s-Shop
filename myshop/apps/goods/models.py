...
# from ckeditor5.fields import RichTextField, RichTextFormField
...
class Goods(BaseModel):
    ...
    # desc_detail = RichTextFormField(default="", verbose_name="详情介绍")
    # desc_pack = RichTextField(default="", verbose_name="包装信息")
    # desc_service = RichTextFormField(default="", verbose_name="售后服务")
...
class SKU(BaseModel):
    ...
    category = models.ForeignKey(GoodsCategory, on_delete=models.PROTECT, verbose_name="从属级别")
